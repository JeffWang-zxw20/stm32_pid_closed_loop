...
{
    volatile int i = 0;  //Objects declared as volatile are omitted from optimization 
							//because their values can be changed by code outside the scope of current code at any time. 
    i++;
}
